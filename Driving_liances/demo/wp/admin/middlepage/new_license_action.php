<?php
	    ...
	    if(isset($_POST['submit']))
		{
			...
			if($nl_id !='')
			{
				...
				if($query<=1)
				{
					header('location:../index.php?page=new_license_view');
				}
				else
				{
		...
		else
		{
			...
			if($status !="")
			{
				if($status == 'Active')
				{
					...
					if($query)
					{
						header('location:index.php?page=new_license_view&msg=Status Update Successfuly');	
					}
					else
					{
						header('location:index.php?page=new_license_view&msg=!Error for status update');	
					}
				}
				else
				{
					...
					{
						header('location:index.php?page=new_license_view&msg=status not Update Successfuly');	
					}
				}
			}
