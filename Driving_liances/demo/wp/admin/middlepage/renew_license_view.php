...
<ul class="breadcrumb">
<li><a href="index.php?page=renew_license_form">Home</a></li>
</ul>
...
<a href = "index.php?page=renew_license_action&rl_id=<?php echo $data['rl_id']; ?>" class="btn btn-danger">Delete</a>
