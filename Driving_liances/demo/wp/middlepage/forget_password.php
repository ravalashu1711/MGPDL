...
<form action="index.php?page=forget_password_action" method="post" enctype="multipart/form-data">
				...
				<div class="row">
					...
					<label style="margin-left: 50px; margin-bottom: 10px;" for="user_login"><b>Email / UserName:</b></label>
							<div class="form-group">
									...
									<input type="text" class="form-with-icon" name="uname" id="uname" placeholder="Enter Email_id Or Username ..*" title="UserName" value="" size="22" tabindex="1" aria-required='true' onblur="return uuname_fun();" />
							</div>
					</div>
