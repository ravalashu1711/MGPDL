...
<form action="index.php?page=renew_license_login_action" method="post" enctype="multipart/form-data">
...
?>
				...
				<div class="row">
					...
					<div class="col-sm-8">
					<label style="margin-left: 50px; margin-bottom: 10px;" for="user_login"><b>License No :</b></label>
							<div class="form-group">
									
									<span class="form-icon" ><i class="fa fa-envelope"></i></span>
									<input type="text" class="form-with-icon" name="nl_id" id="nl_id" placeholder="Enter License No  ..*" title="Reg_No" value="" size="22" tabindex="1" aria-required='true' onblur="return uuname_fun();" />
							</div>
					</div>
