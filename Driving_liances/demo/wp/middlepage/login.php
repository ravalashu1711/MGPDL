...
?>
				...
				<div class="row">
					...
					<div class="col-sm-8">
					<label style="margin-left: 50px; margin-bottom: 10px;" for="user_login"><b>Email / UserName:</b></label>
							<div class="form-group">
									
									<span class="form-icon"><i class="fa fa-envelope"></i></span>
									<input type="text" class="form-with-icon" name="uname" id="uname" placeholder="Enter Email_id Or Username ..*" title="UserName" value="" size="22" tabindex="1" aria-required='true' onblur="return uname_fun();" required="" />
							</div>
					</div>
					...
					<label style="margin-left: 50px; margin-bottom: 10px;" for="user_login"><b>Password:</b></label>
							<div class="form-group">
									...
									<input type="password" class="form-with-icon" name="password" id="password" placeholder="Enter Password ..*" title="Password" value="" size="22" tabindex="1" aria-required='true' required="" />
					...
					<div class="col-sm-8">
						<br><br><a href="index.php?page=forget_password" style='color:blue; font-size: 15px;'><b>Forget Password</b></a>
					</div>
					
					<div class="col-sm-8">
						<label style="margin-top: 20px"><h4>For New People</h4></label>
					</div>

					<div class="col-sm-8">
						<a href="index.php?page=reg" style='color:blue; font-size: 15px;'><b>Register Here</b></a>
					</div>
