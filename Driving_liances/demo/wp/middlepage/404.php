		...
		<div class="span12">
			...
			<div class="error-container">
				...
				<div class="error-details">
					<h2><b>Sorry, an error has occured, Requested page not found!</b></h2>
					<br><br>
				</div> <!-- /error-details -->
				
				<div class="error-actions">
					<a href="index.php?page=home" class="btn btn-large btn-primary">
						<i class="icon-chevron-left"></i>
						&nbsp;
						<h5 style="color: black;">Back to Home</h5>						
					</a>
