				...
				<div class="row">
					...
					<label style="margin-left: 50px; margin-bottom: 10px;" for="user_login"><b>Registration No :</b></label>
							<div class="form-group">
									...
									<input type="text" class="form-with-icon" name="rl_id" id="rl_id" placeholder="Enter Registration No  ..*" title="Reg_No" value="" size="22" tabindex="1" aria-required='true' onblur="return uuname_fun();" />
							</div>
					</div>
