...
<form action="index.php?page=appnew_login_action" method="post" enctype="multipart/form-data">
				...
				<div class="row">
					...
					<div class="col-sm-8">
							...
							<div class="form-group">
									...
									<input type="text" class="form-with-icon" name="u_id" id="u_id" placeholder="Enter User_Id *" title="User_Id" value="" size="22" tabindex="1" aria-required='true' required="" />
							</div>
					</div>
					...
					<label style="margin-left: 50px; margin-bottom: 10px;" for="user_login"><b>Payment No :</b></label>
							<div class="form-group">
									...
									<span class="form-icon"><i class="fa fa-comment"></i></span>
									<input type="text" class="form-with-icon" name="pay_id" id="pay_id" placeholder="Enter Payment No  ..*" title="Pay_No" value="" size="22" tabindex="1" aria-required='true' required="" />
							</div>
					</div>
